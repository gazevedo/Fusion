...
class FrmLogin(customtkinter.CTk, ViewController):
    def __init__(self, window):
        ...
        self.login_label = customtkinter.CTkLabel(self.frame_login, text="Bem-Vindo", font=customtkinter.CTkFont(size=30, weight="bold"))
        self.login_label.pack(padx=(10, 10), pady=(30, 5))

        self.username_entry = customtkinter.CTkEntry(self.frame_login, width=label_width, placeholder_text="username", font=customtkinter.CTkFont(size=16))
        self.username_entry.pack(padx=(10, 10), pady=(30, 10))

        self.password_entry = customtkinter.CTkEntry(self.frame_login, width=label_width, show="*", placeholder_text="password", font=customtkinter.CTkFont(size=16))
        self.password_entry.pack(padx=(10, 10))

        self.login_button = customtkinter.CTkButton(self.frame_login, text="Login", width=200, command=self.onclick_login)
        self.login_button.pack(padx=(10, 10), pady=(30, 5))

        self.label_link2 = customtkinter.CTkLabel(self.frame_login, text=r"http://www.google.com", cursor="hand2", fg_color="transparent")
